...
void escrever_ranking(char modo, char new_winner[31], int new_winner_time){
    ...
    switch(modo){
        case '1':
            file_name = "Arquivos/ranking_iniciante.txt";
            break;
        case '2':
            file_name = "Arquivos/ranking_intermediario.txt";
            break;
        case '3':
            file_name = "Arquivos/ranking_especialista.txt";
            break;
        default:
            NULL;
    }
